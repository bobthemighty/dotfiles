...
notmuch tag -archive +noise +payment_failed -inbox --  tag:inbox and to:f166bb-pay@made.com
notmuch tag -archive +noise -inbox --  from:support@pcapredict.com
notmuch tag -archive +noise -inbox --  from:testingmade12@gmail.com
...
notmuch tag -inbox +noise +alerts -- "Error" and from:productsup
...
notmuch tag -inbox +alerts -- "[Monitor Alert]"

# Reports
notmuch tag +report -inbox -- 'tag:inbox and (from:noreply@newrelic.com or from:ops-accounts@made.com) and "performance report"'
